...
export const AuthorityAlertCard: React.FC<AuthorityAlertCardProps> = ({
  ...
  const highlightStyles = isHighlighted
    ? `ring-2 ring-offset-2 animate-pulse ${severity === 'critical' ? 'ring-red-600 bg-red-50' :
  ...
  return (
    ...
    >
      <CardContent className="p-4">
        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              <AlertTriangle className={`w-5 h-5 ${isHighlighted ? 'animate-bounce' : ''} ${severity === 'critical' ? 'text-red-900' :
        ...
        {/* Victim Information */}
        <div className={`grid grid-cols-2 gap-4 mb-3 pb-3 border-b ${isHighlighted
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1 text-sm text-gray-600">
            ...
            {isHighlighted && (
              <span className={`ml-2 font-bold text-xs uppercase tracking-wider ${severity === 'critical' ? 'text-red-900' :
                  severity === 'high' ? 'text-red-600' :
